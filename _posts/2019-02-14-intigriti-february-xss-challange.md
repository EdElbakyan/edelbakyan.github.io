...
![xss](images/Pasted_image_20220212222129.png)
...
![xss](images/Pasted_image_20220212222447.png)

Trying some xss payloads we can see that  ``` <style onload=alert(1)>```  works and alerts 1.

![xss](images/Pasted_image_20220212222605.png)
...
![xss](images/Pasted_image_20220212223813.png)
